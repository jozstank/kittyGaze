<template>
  ...
  <div class="p-4 sm:ml-64">
    ...
    >
      <h1
        ...
        v-if="catsStore.getLovedCats < 1"
      >
        There is no Liked cat and backward and add the cats that you like
      ...
      >
        <CatCard
          v-for="(item, index) in catsStore.getLovedCats"
          :key="index"
          :cat="item"
        />
      </div>
  ...
  <div
    v-if="catsStore.getLovedCats.length >= 1"
